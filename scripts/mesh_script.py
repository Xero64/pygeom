...
mesh1 = Mesh()
mesh1.add_mesh_vectors('norms', 'MeshNorms')
...
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=0)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=1)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=2)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=3)
mesh1.quads.add(0, 1, 2, 3, norms=[0, 1, 2, 3])
mesh1.grids.add(0.0, 0.0, 0.0)
mesh1.grids.add(0.0, -1.0, 0.0)
mesh1.grids.add(1.0, -1.0, 0.0)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=4)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=5)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=6)
mesh1.trias.add(4, 5, 6, norms=[4, 5, 6])
mesh1.grids.add(0.0, 0.0, 0.0)
mesh1.grids.add(1.0, -1.0, 0.0)
mesh1.grids.add(1.0, 0.0, 0.0)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=7)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=8)
mesh1.mvecs['norms'].add(0.0, 0.0, 1.0, grids=9)
...
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=0)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=1)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=2)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=3)
mesh2.quads.add(0, 1, 2, 3, norms=[0, 1, 2, 3])
mesh2.grids.add(0.0, 0.0, 0.0)
mesh2.grids.add(0.0, 1.0, 0.0)
mesh2.grids.add(-1.0, 1.0, 0.0)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=4)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=5)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=6)
mesh2.trias.add(4, 5, 6, norms=[4, 5, 6])
mesh2.grids.add(0.0, 0.0, 0.0)
mesh2.grids.add(-1.0, 1.0, 0.0)
mesh2.grids.add(-1.0, 0.0, 0.0)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=7)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=8)
mesh2.mvecs['norms'].add(0.0, 0.0, 1.0, grids=9)
...
mesh4.mvecs['norms'].add(0.0, 0.0, 1.0, grids=0)
mesh4.mvecs['norms'].add(0.0, 0.0, 1.0, grids=1)
mesh4.mvecs['norms'].add(0.0, 0.0, 1.0, grids=2)
mesh4.mvecs['norms'].add(0.0, 0.0, 1.0, grids=3)
