...
knots1 = asarray([0.0, 0.0, 0.0, 1.0, 1.0, 1.0], dtype=float64)
knots2 = asarray([0.0, 0.0, 0.0, 0.5, 1.0, 1.0, 1.0], dtype=float64)
...
weights2 = asarray([1.0, 1.0, 1.0, 1.0], dtype=float64)

# bsc = BSplineCurve2D(ctlpts2, knots2)
nc = NurbsCurve2D(ctlpts1, weights=weights1, knots=knots1, endpoint=False)
